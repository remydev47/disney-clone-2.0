              ...
              <section className="relative z-50">
                  ...
                  >
                      <div className="flex items-center justify-between bg-black text-[#f9f9f9] p-3.4">
                          ...
                          <div className="cursor-pointer h-8 w-8 flex
                          jutify-center items-center rounde-lg opacity-50
...
export async function getServerSideProps(context) {
    const session = await getSession(context)
     ...
     const request = await fetch(`https://api.themoviedb.org/3/tv/${id}?api_key=${process.env.API_KEY}&language=en-US&append_to_response=videos`).then((response) => response.json());
